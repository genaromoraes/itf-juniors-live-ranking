  ...
  <script>
    ...
    const translations = {
      "pt-BR": {
        ...
        noWeekTournaments: "Ainda não há torneios coletados para esta semana. A atualização automática continua.",
      ...
      en: {
        ...
        noWeekTournaments: "No tournaments have been collected for this week yet. Automatic updates continue.",
      ...
      es: {
        ...
        noWeekTournaments: "Aún no se han recopilado torneos para esta semana. Las actualizaciones automáticas continúan.",
